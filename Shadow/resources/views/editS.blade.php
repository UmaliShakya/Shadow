            ...
            <div class="row">
                <div class="col-md-3">
                        <div class="list-group">
                                ...
                                <a href="#" class="list-group-item list-group-item-action" ><span class="glyphicon glyphicon-user" aria-hidden="true"></span>  Students <span class="badge">100</span></a>
                                ...
                                <a href="#" class="list-group-item list-group-item-action"><span class="glyphicon glyphicon-user" aria-hidden="true"></span>  Employees <span class="badge">25</span></a>
                ...
                <div class="col-md-9">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading" style=" background: #a41a0e; color:white;"> Edit Students Details</div>
                        
                    </div>
                    
                        <form action="/editStudent/updateStudent/{{$student->id}}"  method="post">@csrf

                          <div class="form-group">
                                <label for="studentname">Student Name</label>
                                <input type="text" class="form-control" id="inputstudentname" placeholder="Enter Student Name" name="Stu_Name" value="{{$student->Stu_Name}}">
                              </div>

                              <div class="form-group">
                                <label for="studentno">Student Age</label>
                                <input type="text" class="form-control" id="inputstudentid" placeholder="Enter Student Age" name="stu_Age" value="{{$student->stu_Age}}">
                              </div>
                    <div class="form-group">
                      <label for="university">University</label>
                      <input type="text" class="form-control" id="university" placeholder="Enter University" name="University" value="{{$student->University}}">
                    </div>
                    ...
                    <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="inputAddress" placeholder="1234 Main St" name="Stu_Address" value="{{$student->Stu_Address}}">
                              </div>

                    <div class="form-group">
                                <label for="studentmobileno">Mobile Number</label>
                                <input type="text" class="form-control" id="inputsmobileno" placeholder="Enter Student Mobile Number" name="Stu_MobileNo" value="{{$student->Stu_MobileNo}}">
                              </div>
                              
                    <div class="form-group">
                        <label for="studentemail">Student Email</label>
                        <input type="text" class="form-control" id="inputstudentemail" placeholder="Enter Student Email"  name="Stu_Emali" value="{{$student->Stu_Emali}}">
                        </div>
                    
             
                  <div class="form-group">
                    <label for="inputgardian'sname">Gardian's Name</label>
                    <input type="inputgardian'sname" class="form-control" id="inputgardian'sname" placeholder="Enter Gardian's Name"  name="GardianName" value="{{$student->GardianName}}">
                  </div>
                  <div class="form-group">
                    <label for="inputgardian'scontactno">Gardian's Contact Number</label>
                    <input type="text" class="form-control" id="inputgardian'scontactno" placeholder="Enter Gardian's Contact Number" name="Gardi_contactNo" value="{{$student->Gardi_contactNo}}">
                  </div>    
