                    ...
                    <div class="panel panel-default">
                        ...
                        @foreach ($employees as $employee)
                                ...
                                <td>{{$employee->id}}</td>
                                  ...
                                  <td>
                                  <a href="{{url('employeeD/view/'.$employee->id)}}" class="btn btn-success" style=" background: #a41a0e; color:white;">View</a>
                                  <a href="{{url('editemployee/'.$employee->id)}}" class="btn btn-default"  style=" background: white; color:black;" >Edit</a>
                                  </td>
                                </tr>
