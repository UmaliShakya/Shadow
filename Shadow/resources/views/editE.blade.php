            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading" style=" background: #a41a0e; color:white;"> Edit Employee Details</div>
                        
                    </div>
                    
                        <form action="/editemployee/updateemployee/{{$employee->id}}"  method="post">@csrf

                          <div class="form-group">
                                <label for="employeename">Employee Name</label>
                                <input type="text" class="form-control" placeholder="Enter Employee Name" name="Emp_Name" value="{{$employee->Emp_Name}}">
                              </div>

                              <div class="form-group">
                                <label for="employeeage">Employee Age</label>
                                <input type="text" class="form-control" placeholder="Enter Employee Age" name="Emp_Age" value="{{$employee->Emp_Age}}">
                              </div>
                    <div class="form-group">
                      <label for="employeeNIC">Employee NIC</label>
                      <input type="text" class="form-control" placeholder="Enter Employee NIC" name="Emp_NIC" value="{{$employee->Emp_NIC}}">
                    </div>

                    <div class="form-group">
                            <label for="employeeAcc">Employee Accountno</label>
                            <input type="text" class="form-control" placeholder="Enter Employee Accountno" name="Emp_AccNo" value="{{$employee->Emp_AccNo}}">
                          </div>

                    <div class="form-group">
                                <label for="employeeAddress">Employee Address</label>
                                <input type="text" class="form-control" placeholder="1234 Main St" name="Emp_Address" value="{{$employee->Emp_Address}}">
                              </div>

                    <div class="form-group">
                                <label for="employeemobileno">Employee Mobile Number</label>
                                <input type="text" class="form-control" placeholder="Enter Employee Mobile Number" name="Emp_MobileNo" value="{{$employee->Emp_MobileNo}}">
                              </div>
                              
                    <div class="form-group">
                        <label for="employeecategory">Employee Email</label>
                        <input type="text" class="form-control" placeholder="Enter Employee Email"  name="Emp_Category" value="{{$employee->Emp_Category}}">
                        </div>
