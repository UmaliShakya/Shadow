                                  ...
                                  <div class="well">
                                        ...
                                        <div class="progress">
                                            ...
                                            <div class="col-md-9 ">
                                                ...
                                                <img src="" alt="">
                                            <h2 style="text-align:center; font-weight:bold; text-size:45px;">{{$student->Stu_Name}}'s Profile</a></h2>
                                                        <div class="row" style="margin-left:80px; font-weight:bold; ">
                                                                        
                                                                <h4 class="container">Student No: &nbsp;{{$student->id}}</h4><br>
                                                                <h4 class="container">Student Name:  &nbsp;{{$student->Stu_Name}}</h4><br>
                                                                <h4 class="container">Student Age: &nbsp;{{$student->stu_Age}}</h4><br>
                                                                <h4 class="container">University: &nbsp;{{$student->University}}</h4><br>
                                                                <h4 class="container">Faculty: &nbsp;{{$student->Faculty}}</h4><br>
                                                                <h4 class="container">Address: &nbsp;{{$student->Stu_Address}}</h4><br>
                                                                <h4 class="container">Mobile No: &nbsp;{{$student->Stu_MobileNo}}</h4><br>
                                                                <h4 class="container">Student Email: &nbsp;{{$student->Stu_Emali}}</h4><br>
                                                                <h4 class="container">Gardian's Name: &nbsp;{{$student->GardianName}}</h4><br>
                                                                <h4 class="container">Gardian's Contact Number: &nbsp;{{$student->Gardi_contactNo}}</h4>
