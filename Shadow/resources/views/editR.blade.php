            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading" style=" background: #a41a0e; color:white;"> Edit Room Details</div>
                        
                    </div>
                    
                        <form action="/editroom/updateroom/{{$room->id}}"  method="post">@csrf

                          <div class="form-group">
                                <label for="roomNo">Room No</label>
                                <input type="text" class="form-control" placeholder="Enter Room No" name="R_No" value="{{$room->R_No}}">
                              </div>

                              <div class="form-group">
                                <label for="roomcategory">Room Category</label>
                                <input type="text" class="form-control" placeholder="Enter Room Category" name="R_Category" value="{{$room->R_Category}}">
                              </div>
                    <div class="form-group">
                      <label for="roomRental">Room Rental</label>
                      <input type="text" class="form-control" placeholder="Enter Room Rental" name="R_Rental" value="{{$room->R_Rental}}">
                    </div>
